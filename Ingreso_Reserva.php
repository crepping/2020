...
<!--
    ...
    <div class="form-group col-md-6">
      <div class="form-group">
            <label for="apoderado">Vehiculos</label>
           ...
           <?php
            ...
            $tabla_deptos = mysqli_query($cnn,"SELECT  * FROM vehiculo where id_cliente like '$cod'");

            while($depto = mysqli_fetch_array($tabla_deptos)) {
            echo "<option value='".utf8_encode($depto['id_vehiculo'])."'>".utf8_encode($depto['patente'])."</option>";
            }
            ?>
        </select>
          </div>
