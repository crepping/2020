...
<body id="page-top">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="nombre" name="nom" placeholder="Nombres">
    </div>
      <div class="form-group col-md-6">
      <label for="inputApellido">Apellido</label>
      <input type="text" class="form-control" id="apellido" name="ape" placeholder="Apellidos">
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Telefono</label>
      <input type="num" class="form-control" id="telefono" name="fono" placeholder="Ingrese telefono">
    </div>
  </div>
  <div class="form-group">
    <label for="inputAddress">Direccion</label>
    <input type="text" class="form-control" id="direccion" name="dir" placeholder="Ingrese Direccion">
  </div>
  <div class="form-group">
  ...
  <button type="submit" name="aceptar" value="Ingresar" class="btn btn-primary">Ingresar Cliente</button>
    ...
    $in="insert into cliente(rut,nombres,apellidos,telefono,direccion,email_cl,fecha_ingreso) values ('$rut','$nom','$ape','$fono','$dir','$email','".date("Y-m-d H:i:s")."')";   
    $dato=mysqli_query($cnn,$in); 
    if (!$dato) {
    echo"<br>"."<br>";
      echo"<script>alert('Error al Ingresar al Cliente')</script>";
    }else{
    echo"<br>"."<br>";
