...
$salida ="";
$query ="select r.id_reserva,c.rut,c.nombres,c.apellidos,c.telefono,v.patente,r.fecha_reserv,r.Hora,r.ingreso_fecha,r.estado_reserva from reserva r,cliente c,vehiculo v where c.id_cliente = r.id_cliente and c.id_cliente = v.id_cliente and r.id_vehiculo = v.id_vehiculo and r.estado_reserva = 1 ";
if (isset($_POST['consulta'])) {
	$q = $mysqli->real_escape_string($_POST['consulta']);
	//select r.id_reserva,c.rut,c.nombres,c.apellidos,c.telefono,v.patente,r.fecha_reserv,r.Hora,r.ingreso_fecha,r.estado_reserva from reserva r,cliente c,vehiculo v where c.id_cliente = r.id_cliente and c.id_cliente = v.id_cliente and r.id_vehiculo = v.id_vehiculo and r.estado_reserva = 1
	$query = "select r.id_reserva,c.rut,c.nombres,c.apellidos,c.telefono,v.patente,r.fecha_reserv,r.Hora,r.ingreso_fecha,r.estado_reserva from reserva r,cliente c,vehiculo v where c.id_cliente = r.id_cliente and c.id_cliente = v.id_cliente and r.id_vehiculo = v.id_vehiculo and r.estado_reserva = 1 ";
}
...
'url': '//cdn.datatables.net/plug-ins/1.10.19/i18n/Spanish.json'
    ...
    <strong>No hay Datos!</strong> No hay registro de nuevas reservas Pendientes.
  </div>
	";
